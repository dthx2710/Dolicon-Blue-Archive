        ...
        <section className="section">
          ...
          >
            ...
            <div className="has-text-centered">
                ...
                <img src={`../../img/Katakana_Name_Error.webp`} alt="Katakana Name Error" width="600"/>
                ...
                <img src={`../../img/changename2.webp`} alt="changename2" width="600"/>
                <hr/>
                <h3>Q. Crafting nodes?</h3>  
                <h3>A. </h3>
                <img src={`../../img/Crafting.webp`} alt="Crafting" width="600"/>
                <hr/>
                <h3>Q. WTF is FAQ???</h3>
